...
@Component
@JsonIdentityInfo(generator=ObjectIdGenerators.IntSequenceGenerator.class, property="@id",scope=CustomerSpecificDetails.class)
public class CustomerSpecificDetails {
	...
	public CustomerSpecificDetails(long customer_id, String cust_first_name, String cust_last_name, String date_of_birth, String phone_number, String cust_email, String cust_address, double point_score) {
